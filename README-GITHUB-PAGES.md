...
- Si cambias archivos y el movil sigue mostrando una version antigua, abre la app una vez con conexion y recarga. El service worker usa la cache `hidrantes-github-pages-v4`.
